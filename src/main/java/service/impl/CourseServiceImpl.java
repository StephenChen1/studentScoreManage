...
public class CourseServiceImpl implements CourseService {
	...
	public List<CourseSimpleMessage> getCourseByIdYearSems(String teacherId, String year, int semester,
			String isEnteredFlag) {
		...
		List<CourseSimpleMessage> courses = courseMessageDao.getCourseByIdYearSems(teacherId, year, semester,
				isEntered);
